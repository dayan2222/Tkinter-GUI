...
for i in range(0, 3):
    ...
    image = image.resize((300, 265), Image.ANTIALIAS)
    photos.append(ImageTk.PhotoImage(image))

f0 = Frame(root, width=800, height=70)
Label(f0, text="News With Tkinter", font="lucida 33 bold").pack()
Label(f0, text="August 21, 2019", font="lucida 13 bold").pack()
f0.pack()
